...
CodeGrid is a local-first, open-source desktop app published by ZipLyne LLC. The desktop app has no
ZipLyne telemetry or required backend; optional BYOK features connect directly to their named
providers. See the full model at <https://codegrid.app/security>.
...
- Open a [private security advisory](https://github.com/ZipLyne-Agency/CodeGrid/security/advisories/new) on this repository.
