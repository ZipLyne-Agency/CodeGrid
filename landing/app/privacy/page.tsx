        ...
        <div className="space-y-8 text-sm leading-relaxed text-text-primary">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>
                <strong>OpenAI</strong> &mdash; receives the relevant diff, terminal text,
                or voice audio only when you explicitly use an optional BYOK AI feature in
                the desktop app, under OpenAI&apos;s terms and using your API key.
              </li>
            </ul>
          </section>
