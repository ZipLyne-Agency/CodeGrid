...
const REPO = "https://github.com/ZipLyne-Agency/CodeGrid";
...
const installs: { k: string; t: string; d: string; code?: string; note?: string }[] = [
  {
    ...
    code: "git clone --depth 1 https://github.com/ZipLyne-Agency/CodeGrid\ncp -r CodeGrid/skills/* ~/.claude/skills/",
  },
  {
    k: "02",
  ...
  },
  {
    ...
    note: "In OpenClaw, install the CodeGrid skill from the skills/ directory of the ZipLyne-Agency/CodeGrid repo.",
  },
];
