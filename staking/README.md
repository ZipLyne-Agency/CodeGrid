# Archived: $GRID staking prototype

> This directory is retained as historical open-source material. CodeGrid 0.1.74 and later are fully free and do not use these contracts, Workers, wallet links, points, or entitlement JWTs. Nothing here is required to build or run the current desktop app.
